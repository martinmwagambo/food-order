...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="Login_v13/vgendor/daterangepicker/daterangepicker.css">
...
<body style="background-color: #999999;">
  ...
  <div class="limiter">
    <div class="container-login100">
      <div class="login100-more" style="background-image: url(images/burger.jpg);" width="100px"></div>
      ...
      <div class="wrap-login100 p-l-50 p-r-50 p-t-72 p-b-50">
        ...
        Log In </button>
            ...
            <a href="<?php ?>" class="dis-block txt3 hov1 p-r-30 p-t-10 p-b-10 p-l-30">
              Back to Home Page </a>
          </div>
        </form>
